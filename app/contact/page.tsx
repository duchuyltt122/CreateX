        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">contact@createx.vn</p>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-orange-400 to-pink-500 rounded-lg p-8 text-white">
              ...
              <p className="mb-6">
                We'd love to hear from you! Whether you have questions about our workshops, 
                need assistance with booking, or want to collaborate, feel free to reach out.
              </p>
            ...
            <div className="mt-6 bg-white rounded-lg shadow-md p-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center hover:bg-orange-500 hover:text-white transition-colors">
